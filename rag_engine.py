...
class RAGEngine:
    ...
    def _get_temperature(self, model_name):
        ...
        o-series models (o3, o4) require temperature=1, others use 0.7
        
        CRITICAL: OpenAI's reasoning models (o3-mini, o4-mini, etc.) 
        ONLY accept temperature=1 and will throw 400 error with any other value!
        """
        if model_name.startswith("o3") or model_name.startswith("o4") or model_name.startswith("o1"):
            print(f"[Temperature] Using temperature=1 for reasoning model: {model_name}")
            return 1.0
        else:
            print(f"[Temperature] Using temperature=0.7 for model: {model_name}")
            return 0.7
    ...
    def setup_chain(self):
        ...
        try:
            # FIXED: Get correct temperature for this model
    ...
    def switch_model(self, new_model):
        ...
        try:
            # FIXED: Get correct temperature for new model
